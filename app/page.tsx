...
export default function Home() {
  return (
    <main className="home">
      <div className="ref" />
      <div className="stars" />
      <div className="red-glow" /><div className="blue-glow" />
      <div className="left-land" /><div className="sea" />
      ...
      <div className="smoke" /><div className="volcano" />
      <div className="elephant">
        <div className="ear left" /><div className="ear right" />
        <div className="head" /><div className="trunk" />
        <div className="tusk left" /><div className="tusk right" />
      ...
      <section className="hero">
        ...
        <div className="cards">
          <Link className="card red-card" href="/regole">
            ...
            <span className="card-text"><h2>REGOLE DEL SITO</h2><p>Leggi il regolamento completo per vivere al meglio la community.</p></span>
            <span className="card-arrow">›</span>
          </Link>
          <Link className="card blue-card" href="/muro">
            <span className="card-icon">💬</span>
            <span className="card-text"><h2>MURO DEI TIFOSI</h2><p>Scrivi, leggi e condividi la tua passione rossazzurra.</p></span>
            <span className="card-arrow">›</span>
          </Link>
        </div>
